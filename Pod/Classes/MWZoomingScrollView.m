...
- (id)initWithPhotoBrowser:(MWPhotoBrowser *)browser {
    if ((self = [super init])) {
        ...
        _tapView.backgroundColor = browser.view.backgroundColor;
        ...
        _photoImageView.backgroundColor = browser.view.backgroundColor;
		...
		// Setup
		self.backgroundColor = browser.view.backgroundColor;
		self.delegate = self;
